...
# Train model via sidebar button
...
if submit and model and scaler:
    ...
    segment_names = {
        0: "Budget Shoppers",
        1: "Young Spenders",
        2: "High Income Target",
        3: "Low Engagement",
        4: "Luxury Loyalists"
    }
    segment_name = segment_names.get(cluster, "Unknown Segment")

    st.subheader("🧠 Predicted Customer Segment")
    st.success(f"This customer belongs to **Segment #{cluster} - {segment_name}**")
